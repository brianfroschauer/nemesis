...
public class EmailSender {
    ...
    private static final String purchaseHtml = "<!doctype html>\n" +
            "<html>\n" +
            "<head>\n" +
    ...
    private static final String confirmationHtml = "<!doctype html>\n" +
            "<html>\n" +
            "<head>\n" +
            "    <meta name=\"viewport\" content=\"width=device-width\">\n" +
            "    <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\">\n" +
            ...
            "                                    <td style=\"font-family: sans-serif; font-size: 14px; vertical-align: top;\" valign=\"top\">\n" +
            "                                        <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;\">Hola,</p>\n" +
            "                                        <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;\">Bienvenido a Nemesis, muchas gracias por registrarte.</p> <p>Para terminar el registro, por favor inicia sesión:</p>\n" +
            "                                        <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"btn btn-primary\" style=\"border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;\" width=\"100%\">\n" +
            "                                            <tbody>\n" +
            "                                            <tr>\n" +
            "                                                <td align=\"left\" style=\"font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;\" valign=\"top\">\n" +
            ...
            "                                            </tbody>\n" +
            "                                        </table>\n" +
            "                                        <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;\">Gracias por elegirnos,</p>\n" +
            "                                        <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;\">El equipo de Nemesis</p>\n" +
            "                                    </td>\n" +
            "                                </tr>\n" +
            "                            </table>\n" +
            "                        </td>\n" +
    ...
    public static void sendPurchaseEmail(String recipient, String subject) {
        ...
        try {
            ...
            message.setContent(purchaseHtml, "text/html");
    ...
    public static void sendConfirmationEmail(String recipient, String subject) {
        final Properties props = System.getProperties();
        props.put("mail.smtp.starttls.enable", "true");
        props.put("mail.smtp.host", "smtp.gmail.com");
        props.put("mail.smtp.user", username);
        ...
        try {
            ...
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(recipient));
            message.setSubject(subject);
            message.setContent(confirmationHtml, "text/html");
            Transport transport = session.getTransport("smtp");
            transport.connect("smtp.gmail.com", username, password);
            transport.sendMessage(message, message.getAllRecipients());
            transport.close();
